...
若要运行 DeviceExplorer 工具，请使用[步骤 1](#Step_1_Sign_Up) 中所述的以下配置字符串：
...
**注意：** 请对本部分中执行的所有操作进行屏幕截图。 [步骤 4](#Step_4_2_Share) 中需要用到这些屏幕截图。
...
4.  请向我们发送明确的说明，描述如何使用你的硬件运行此示例（明确强调客户要执行的新步骤）。 请使用[此处](<https://github.com/Azure/azure-iot-device-ecosystem/blob/master/iotcertification/templates/template-windows-c.md>)提供的模板创建设备特定的说明。
