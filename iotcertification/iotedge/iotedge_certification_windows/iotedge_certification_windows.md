...
遵照[此处](https://account.windowsazure.com/signup?offer=ms-azr-0044p)所述的说明[注册](https://docs.microsoft.com/en-us/azure/iot-edge/quickstart) Azure IoT 中心服务。 在注册过程中，将会收到连接字符串。
